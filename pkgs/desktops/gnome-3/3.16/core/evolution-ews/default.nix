{ stdenv, fetchurl, gnome3, pkgconfig, intltool, glib, evolution_data_server, gtk, libsoup, sqlite, evolution, webkitgtk, libmsgpack }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = with gnome3;
     [ pkgconfig intltool glib evolution_data_server gtk libsoup sqlite evolution webkitgtk libmsgpack ];

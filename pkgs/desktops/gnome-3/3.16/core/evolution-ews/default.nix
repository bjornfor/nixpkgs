{ stdenv, fetchurl, gnome3, pkgconfig, intltool, glib, evolution_data_server, gtk, libsoup, sqlite, evolution }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = with gnome3;
     [ pkgconfig intltool glib evolution_data_server gtk libsoup sqlite evolution ];

...
runCommand "evolution-with-plugins" {} ''
  ...
  ## The perl replacer messes up ELF files.
  #cat > perl-replacer << __EOF__
  ##!${stdenv.shell}
  #set -x
  #i=\$1
  #cat "\$i" \
  ...
  #mv "\$i.tmp" "\$i"
  #__EOF__
  #chmod +x perl-replacer
  #find "$out" -type f -exec ./perl-replacer '{}' \;

  # The bbe replacer messes up ELF files too.
